...
wandb.init(project="en-th-thai_romanize_pytorch_seq2seq_attention")
...
def load_data(data_path):
    ...
    target_texts =[str(i) for i in list(data_path['roman'])] # list(data_path['roman'])
...
show_inference_example(model, ['ok'], [''], char_2_ix, ix_2_char, target_char_to_ix, ix_to_target_char)
